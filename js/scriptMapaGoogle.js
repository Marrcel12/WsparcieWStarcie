...
function mapaStart() {
    ...
    markerAdd(52.262221, 21.045163, {
        title: 'ul. Szwedzka 6/82',
        clickable: true,
        icon: ikona
    }, '<strong>Stowarzyszenie Serduszko dla Dzieci,</strong><br/> ul. Szwedzka 6/82, Praga-Północ, Warszawa');

    markerAdd(52.260353, 21.041877, {
        title: 'ul. Stalowa 28/1',
        clickable: true,
        icon: ikona
    }, '<strong>Towarzystwo Przyjaciół Pragi,</strong><br/> ul. Stalowa 28/1, Praga-Północ, Warszawa');

markerAdd(52.199363, 21.149317, {
        title: 'ul. Motylkowa 59b',
        clickable: true,
        icon: ikona
    }, '<strong>Fundacja Miejsce Kreatywne,</strong><br/> ul.  Motylkowa 59b, Praga-Północ, Warszawa');
}
